package me.sirrus86.s86powers.tools.nms.v1_19_2;
...
//	private static final int d = 1;
	...
	private void h() {
		BlockPosition blockposition = this.f.da();
		for (int i = 0; i < 10; i++) {
			int j = a(-3, 3);
			int k = a(-1, 1);
			int l = a(-3, 3);
	...
	private boolean a(int i, int j, int k) {
		if (Math.abs(i - this.f.dg()) < 2.0D && Math.abs(k - this.f.dl()) < 2.0D) {
			return false;
		}
		...
		Location to = new Location(entity.getWorld(), i + 0.5D, j, k + 0.5D, this.e.dq(), this.e.ds());
	...
	private boolean a(BlockPosition blockposition) {
		...
		BlockPosition blockposition1 = blockposition.b((BaseBlockPosition)this.e.da());
		return this.g.a((Entity)this.e, this.e.cz().a(blockposition1));
	}

	private int a(int i, int j) {
		return this.e.dQ().a(j - i + 1) + i;
	}
}