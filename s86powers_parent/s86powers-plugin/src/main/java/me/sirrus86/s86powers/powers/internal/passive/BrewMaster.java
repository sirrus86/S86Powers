...
@PowerManifest(name = "Brew Master", type = PowerType.PASSIVE, author = "sirrus86", concept = "Swagofswag", incomplete = true, icon=Material.POTION,
...
public class BrewMaster extends Power {
	...
	private final Set<Material> potMats = Sets.newHashSet(Material.POTION, Material.SPLASH_POTION, Material.LINGERING_POTION);
	private int stack;
