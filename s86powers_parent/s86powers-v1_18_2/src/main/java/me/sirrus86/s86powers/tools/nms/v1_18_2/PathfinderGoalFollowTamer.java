...
//	private static final int d = 1;
	...
	//		Location to = new Location(entity.getWorld(), i + 0.5D, j, k + 0.5D, this.e.dn(), this.e.do());
			Location to;
			to = new Location(entity.getWorld(), i + 0.5D, j, k + 0.5D, this.e.dn(), (float) this.e.getClass().getMethod("do").invoke(this.e)); // Workaround for NMS naming a method "do", won't compile normally
