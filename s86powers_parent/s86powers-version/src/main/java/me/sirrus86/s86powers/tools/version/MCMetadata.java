...
public class MCMetadata {
	...
	public enum EntityMeta {
		...
		ENTITY_CUSTOM_NAME(2,2,2,2,String.class), //TODO OptChat
		...
		AREAEFFECTCLOUD_PARTICLE(9,10,10,10,Particle.class), //TODO Particle data
		...
		ENDERCRYSTAL_BEAM_TARGET(6,7,7,7,BlockVector.class), //TODO OptBlockPos
		...
		FIREWORK_ITEM(6,7,7,00,ItemStack.class),
		FIREWORK_SHOOTER_ENTITY_ID(7,8,8,8,Integer.class), //TODO OptVarInt
		...
		LIVINGENTITY_BED_LOCATION(-1,12,13,13,BlockVector.class), //TODO OptBlockPos
		...
		PLAYER_LEFT_SHOULDER_ENTITY(15,17,18,18,Entity.class), //TODO NBT
		PLAYER_RIGHT_SHOULDER_ENTITY(16,18,19,19,Entity.class), //TODO NBT

		ARMORSTAND_OPTIONS(11,13,14,14,Byte.class),
		ARMORSTAND_HEAD_ROTATION(12,14,15,15,Vector.class), //TODO Rotation
		ARMORSTAND_BODY_ROTATION(13,15,16,16,Vector.class), //TODO Rotation
		ARMORSTAND_LEFT_ARM_ROTATION(14,16,17,17,Vector.class), //TODO Rotation
		ARMORSTAND_RIGHT_ARM_ROTATION(15,17,18,18,Vector.class), //TODO Rotation
		ARMORSTAND_LEFT_LEG_ROTATION(16,18,19,19,Vector.class), //TODO Rotation
		ARMORSTAND_RIGHT_LEG_ROTATION(17,19,20,20,Vector.class), //TODO Rotation

		MOB_STATE(11,13,14,14,Byte.class),

		BAT_IS_HANGING(12,14,15,15,Byte.class),

		DOLPHIN_TREASURE_POSITION(12,14,15,15,Vector.class), //TODO Position
		...
		HORSE_OWNER_UUID(14,16,17,17,UUID.class), //TODO: OptUUID

		HORSE_VARIANT(15,17,18,18,Integer.class),
		HORSE_ARMOR(16,-1,-1,-1,Integer.class), //TODO Missing 1.14?
		HORSE_ARMOR_ITEM(17,-1,-1,-1,ItemStack.class), //TODO Missing 1.14?
		...
		FOX_FIRST_UUID(-1,17,18,18,UUID.class), //TODO: OptUUID
		FOX_SECOND_UUID(-1,18,19,19,UUID.class), //TODO: OptUUID
		...
		TAMEABLE_OWNER_UUID(14,16,17,17,UUID.class), //TODO: OptUUID
		...
		WOLF_DAMAGE_TAKEN(15,17,-1,-1,Float.class), //TODO Missing in 1.15?
		...
		VILLAGER_PROFESSION(13,-1,-1,-1,Integer.class), //TODO Missing in 1.14?
		VILLAGER_DATA(-1,16,17,17,Villager.class), //TODO VillagerData
		...
		SHULKER_ATTACH_POSITION(13,15,16,16,BlockVector.class), //TODO: OptPosition
		...
		ILLAGER_HAS_TARGET(12,-1,-1,-1,Byte.class), //TODO Missing in 1.14?
		...
		SKELETON_IS_SWINGING_ARMS(12,-1,-1,-1,Boolean.class), //TODO Missing in 1.14?
		...
		ZOMBIE_HAS_HANDS_UP(14,-1,-1,-1,Boolean.class), //TODO Missing in 1.14?
		ZOMBIE_IS_DROWNING(15,16,17,17,Boolean.class),
		
		ZOMBIE_VILLAGER_IS_CONVERTING(16,17,18,18,Boolean.class),
		ZOMBIE_VILLAGER_PROFESSION(17,18,-1,-1,Integer.class), //TODO Missing in 1.15?
		ZOMBIE_VILLAGER_DATA(-1,-1,19,19,Villager.class), //TODO VillagerData

		ENDERMAN_CARRIED_BLOCK(12,14,15,15,BlockState.class), //TODO: OptBlock
		...
		MINECARTCOMMANDBLOCK_LAST_OUTPUT(12,14,14,14,String.class), //TODO: Chat

		TNTPRIMED_FUSE_TIME(6,7,7,7,Integer.class),
		;
		
		private int v1_13,v1_14,v1_15,v1_16;
		private Class<?> type;
		
		private EntityMeta(int v1_13, int v1_14, int v1_15, int v1_16, Class<?> type) {
			this.v1_13 = v1_13;
			this.v1_14 = v1_14;
			this.v1_15 = v1_15;
			this.v1_16 = v1_16;
