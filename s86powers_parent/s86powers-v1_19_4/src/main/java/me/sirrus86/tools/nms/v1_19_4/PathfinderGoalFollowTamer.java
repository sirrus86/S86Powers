...
//	private static final int d = 1;
	...
	public PathfinderGoalFollowTamer(EntityInsentient entitytameableanimal, EntityHuman owner, double d0, float f, float f1, boolean flag) {
		...
		this.g = (IWorldReader)entitytameableanimal.H;
		this.h = d0;
		this.i = entitytameableanimal.G();
		this.l = f;
		this.k = f1;
		this.n = flag;
		a(EnumSet.of(Type.a, Type.b));
		this.owner = owner;
	...
	public void e() {
		this.e.C().a((Entity)this.f, 10.0F, this.e.V());
		if (--this.j <= 0) {
			this.j = a(10);
	...
	private boolean a(int i, int j, int k) {
		...
		Location to = new Location(entity.getWorld(), i + 0.5D, j, k + 0.5D, this.e.dw(), this.e.dx());
		EntityTeleportEvent event = new EntityTeleportEvent((org.bukkit.entity.Entity)entity, entity.getLocation(), to);
		this.e.H.getCraftServer().getPluginManager().callEvent((Event)event);
	...
	private boolean a(BlockPosition blockposition) {
		...
		BlockPosition blockposition1 = blockposition.b((BaseBlockPosition)this.e.dg());
