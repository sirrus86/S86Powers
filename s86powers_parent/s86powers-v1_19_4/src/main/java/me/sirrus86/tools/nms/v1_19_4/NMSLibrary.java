...
//		return types;
	...
	public void removePathfinding(Creature entity) {
		try {
			...
			handle.bN = new PathfinderGoalSelector(handle.H.ad());
			handle.bO = new PathfinderGoalSelector(handle.H.ad());
...
//			}
	...
	public void setTamed(Creature entity, Player player) {
		try {
			entity.setTarget(null);
			EntityCreature handle = ((CraftCreature)entity).getHandle();
			PathfinderGoalSelector goalSelector = handle.bN,
					targetSelector = handle.bO;
	...
	public void unTame(Creature entity) {
		try {
			EntityCreature handle = ((CraftCreature)entity).getHandle();
			PathfinderGoalSelector[] goalSelectors = { handle.bN, handle.bO };
